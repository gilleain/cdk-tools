...
import tools.depict.blocktree.visitor.BlockFinder;
...
public class GraphEmbedder {
	...
	public static GraphEmbedding embed(IAtomContainer atomContainer) {
		 
        // find all the blocks in the graph
        BlockFinder finder = new BlockFinder();
        GraphObject graphObject = new GraphObject(atomContainer);
